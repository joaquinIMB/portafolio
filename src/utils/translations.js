export const translations = {
  es: {
    ...
    contactMeSection: {
      ...
      paragraph1:
        "Hagamos realidad tu próxima página web con un diseño y funcionalidad excepcionales.",
    },
    contactMePage: {
      title: "Trabajemos juntos",
      inputForm1: "Nombre",
      inputForm2: "Apellido",
      inputForm3: "Correo electrónico",
      inputForm4: "Teléfono",
      textInputForm4: "No olvides agregar el código de país",
      inputForm5: "Mensaje",
  ...
  en: {
    ...
    mainPage: {
      title: "Hi, I'm Joaco!",
      paragraph1: "Full Stack Developer",
    ...
    contactMeSection: {
      ...
      paragraph1:
        "Let's bring your next website to life with exceptional design and functionality.",
    },
    contactMePage: {
      title: "Let's Work Together",
      inputForm1: "First Name",
      inputForm2: "Last Name",
      inputForm3: "Email",
      inputForm4: "Phone",
      textInputForm4: "Don't forget to add the country code",
      inputForm5: "Message",
