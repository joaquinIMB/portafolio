...
const Home = () => {
  return (
    <main id="home" className="relative flex items-center px-20 pt-20 pb-8 w-[90%] max-sm:px-2 max-sm:pb-10 h-[90vh] max-sm:justify-center max-sm:w-[98%] max-sm:text-center transition-all">
